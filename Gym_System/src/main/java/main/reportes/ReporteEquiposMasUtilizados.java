 ...
 * @author marco
 */
public class ReporteEquiposMasUtilizados {

    private int idEquipo;
    private String equipo;
    private int vecesUtilizado;

    public ReporteEquiposMasUtilizados() {
    }

    public ReporteEquiposMasUtilizados(int idEquipo, String equipo, int vecesUtilizado) {
